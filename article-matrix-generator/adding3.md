...
先记住一个原则，下面这些句子不是模板，不能照着复读。

开头有效，不是因为用了「故事是这样的」「最近这两天」这些固定句式，而是因为它们后面马上接了具体动作、具体画面、具体反差。可迁移的是入口机制，不是原句。

**叙事启动型：**
> 故事是这样的。
> 我最近刷淘宝挺多，然后昨天，鬼使神差的，在淘宝上，搜了一下DeepSeek。

机制拆解：有效点不在「故事是这样的」，而在「昨天」「淘宝」「搜了一下DeepSeek」这3个具体动作和场景。读者马上知道，这个人真的下场了。

什么时候不能用：如果后面接的是抽象判断，比如「我最近思考了AI时代的变化」，这句就会立刻变油。

> 故事是这样的。
> 是周末跟一个刚毕业两三年的朋友聊天，聊到了天赋这个词。

机制拆解：这是对话截面入口。它不是凭空讲方法论，而是从一个真实朋友、一个具体聊天场景里长出来。

什么时候不能用：如果素材里没有真实对话或具体人物，不要硬编朋友。

**荒诞事实型：**
> 我可能，刚刚成为了哈基米的儿子。
> 至少，AI是这么认为的。

机制拆解：先抛结果，再制造疑问。读者会想知道，AI为什么会这么认为，这就是结果倒挂。

什么时候不能用：如果结果不够荒诞，不要硬装震惊。普通事实加夸张语气，会显得特别像AI在演人。

> 这个世界，终于魔幻到我看不懂的程度了。

机制拆解：这句本身很短，但必须依赖后面马上跟一个具体魔幻事实。它只能当情绪引线，不能当内容本身。

什么时候不能用：如果后面没有价格、截图、订单、评论、测试结果这种硬细节，就不要这么开。

**热点破题型：**
> 最近这两天，被一个三宫格AI图片给刷屏了。

机制拆解：热点破题能用，是因为「三宫格AI图片」足够具体，读者能立刻在脑子里调出画面。

什么时候不能用：不要写成「最近AI圈又出了一件大事」。这句话没有画面，也没有新鲜感。

> Seedance2.0的火，已经烧了好几天了。
> 抖音b站到处都是二创视频，微博科技榜一下子上了四个热搜。

机制拆解：这里不是泛泛说火，而是给了平台和热搜数量，热度变得可感知。

什么时候不能用：如果只是单平台小范围传播，不要硬写成全网刷屏。

**好奇心驱动型：**
> 这两天在网上刷到了一张图，很有意思。

机制拆解：这是轻开头，适合后面马上展示图片或描述图片里反常的地方。

什么时候不能用：如果后面不能在3句话内说清楚「有意思在哪里」，这句就会变成废话。

> 最近关于OpenClaw的事，除了我昨天说的Github登顶之外。
> 还有另一个非常魔幻的事。

机制拆解：这是连续追踪型开头。它默认读者知道前情，所以可以用「另一个」制造续集感。

什么时候不能用：如果不是系列文章，或者读者没有前情，不要一上来就假设大家都知道。

**感性事件型：**
> 大周末的，起床第一件事，就看到，飞书开源CLI了。。。

机制拆解：这是现场切片入口。「大周末」「起床第一件事」「看到」都在制造即时感。

什么时候不能用：如果你其实没有第一时间看到，不要编这种第一手反应。

> 前天，我们终于开了属于我们自己公司的年会。

机制拆解：这是私人事件入口。它的力量来自「我们自己公司」这个身份位置，而不是来自句式。

什么时候不能用：如果文章主题和私人事件没有内在关系，不要为了活人感硬塞私人生活。

可迁移的开头入口：
- 结果倒挂：先给最反常的结果，再回头讲原因。
- 现场切片：从订单页、截图、按钮、付款、聊天记录、报错信息切入。
- 认知错位：先写我以为很简单，结果发现完全不是。
- 普通人困境：先写一个普通读者正在卡住的具体处境。
- 荒诞事实：直接抛一个足够具体的离谱事实。
- 私人迟疑：先承认不确定、不成熟、不想装懂。
- 对话截面：从朋友、群友、评论区的一句话切入。
- 物件特写：从一个具体东西开始，比如一张图、一个Prompt、一份账单、一台手机。

开头自检：前300字必须有具体细节。第一句话去掉具体名词后，如果能套到任何文章上，重写。
